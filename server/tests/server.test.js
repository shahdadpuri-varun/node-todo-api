...
describe('/GET todos/:id', () => {
    ...
    it('should not return todo doc owned by some other user', (done) => {
        request(app)
            .get(`/todos/${todos[0]._id.toHexString()}`)
...
describe('/PATCH /todos/:id', () => {
    ...
    it('should not update the todo if user not owner', (done) => {
        var id = todos[0]._id.toHexString();
        var body = {};
        body.text = 'Updated the todo';
        body.completed = true;
...
describe('/GET /users/me', () => {
    ...
    it('should return 401 i not authenticated', (done) => {
        request(app)
            .get('/users/me')
            .expect(401)
            .expect((res) => {
